...
return array(
	...
	'fields' => array(
		array(
			...
			'view' => 'default',
			'name' => 'maxWidth',
			'default' => null,  //'.TwoJGalleryHelper::_tr('', 'blog-mechanics-theme-gallery').'
			'label' => '<h5>'.TwoJGalleryHelper::_tr('Max Width Gallery', 'blog-mechanics-theme-gallery').'</h5>',
		...
		array(
			...
			'name' => 'previewSize',
			'default' => 'medium',
			'label' => '<h5>'.TwoJGalleryHelper::_tr('Gallery Thumbnails Quality', 'blog-mechanics-theme-gallery').'</h5>',
		...
		array(
			...
			'label' => '<h5>'.TwoJGalleryHelper::_tr('Gallery Layout Mode', 'blog-mechanics-theme-gallery').'</h5>',
		...
		array(
			...
			'default' => 'first',
			'label' => '<h5>'.TwoJGalleryHelper::_tr('General Gallery Thumbnail', 'blog-mechanics-theme-gallery').'</h5>',
		...
		array(
			...
			'name' => 'align',
			'default' => 'disable',
			'label' => '<h5>'.TwoJGalleryHelper::_tr('Gallery Align', 'blog-mechanics-theme-gallery').'</h5>',
		...
		array(
			...
			'label' => '<h5>'.TwoJGalleryHelper::_tr('Gallery Background Color', 'blog-mechanics-theme-gallery').'</h5>',
