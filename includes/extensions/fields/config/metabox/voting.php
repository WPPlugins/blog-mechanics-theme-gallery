...
wp_register_script( TWOJ_GALLERY_ASSETS_PREFIX.'-field-type-voting', TWOJ_GALLERY_FILEDS_URL.'asset/metabox/voting/script.js', array('jquery'), false, true);

$translation_array = array(
	'messageOk' => 		TwoJGalleryHelper::_tr( 'Thank you very much for your opinion!', 'blog-mechanics-theme-gallery'),
	'messageError' => 	TwoJGalleryHelper::_tr( 'Voting error. Please try again later.', 'blog-mechanics-theme-gallery')
);
