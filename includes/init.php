...
function twoJGalleryCreatePostType() { 
    ...
    register_post_type( TWOJ_GALLERY_TYPE_POST,
        array(
          'labels' => array(
            'name' => '2J Gallery',
            'singular_name' => TwoJGalleryHelper::_tr( '2J Gallery', 		'blog-mechanics-theme-gallery'),
            'all_items'     => TwoJGalleryHelper::_tr( 'Galleries List', 	'blog-mechanics-theme-gallery'),
            'add_new'       => TwoJGalleryHelper::_tr( 'Add Gallery', 		'blog-mechanics-theme-gallery'),
            'add_new_item'  => TwoJGalleryHelper::_tr( 'Add Gallery', 		'blog-mechanics-theme-gallery'),
            'edit_item'     => TwoJGalleryHelper::_tr( 'Edit Gallery', 		'blog-mechanics-theme-gallery'),
          ),
...
function twoj_gallery_plugin_meta( $links, $file ) {
	if ( strpos($file, '/2jgallery.php') !== false ) {
		$links[] = sprintf( 
			...
			TwoJGalleryHelper::_tr( 'Get Premium Version', 'blog-mechanics-theme-gallery') 
		);
	}
	return $links;
}
